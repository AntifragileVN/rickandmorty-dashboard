...
const SideBar = ({ isSideBarOpen, toggleSideBar }: SideBarProps) => {
	...
	return (
		<div
			className={`absolute min-[300px]:flex z-20 min-h-screen overflow-y-auto bg-gray-800 transition-transform transform ease-in-out duration-300  flex-col w-64 ${isSideBarOpen ? '-translate-x-full' : 'hidden'}`}
		>
